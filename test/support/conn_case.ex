defmodule PhoenixChatWeb.ConnCase do
  ...
  by setting `use PhoenixChatWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    ...
    scope = PhoenixChat.Accounts.Scope.for_user(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    PhoenixChat.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end

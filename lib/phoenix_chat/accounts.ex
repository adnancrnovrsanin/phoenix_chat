defmodule PhoenixChat.Accounts do
  ...
  alias PhoenixChat.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  Gets a single user, returning nil if the id does not exist.
  """
  def get_user(id), do: Repo.get(User, id)
  ...
  See `PhoenixChat.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `PhoenixChat.Accounts.User.password_changeset/3` for a list of supported options.
